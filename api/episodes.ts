export const locations = [
  {
    name: "King's Landing",
    description:
      "The capital of the Seven Kingdoms, home to the Kingsguard and the Red Keep.",
  },
  {
    name: "Winterfell",
    description:
      "The capital of the North, home to the Night's Watch and the Watchers.",
  },
  {
    name: "Harrenhal",
    description:
      "A small village in the North, home to the Strong and the Free Cities.",
  },
  {
    name: "The Wall",
    description:
      "A fortified area in the North, home to the Night's Watch and the Watchers.",
  },
  {
    name: "The Eyrie",
    description:
      "Located in the Vale. The Eyrie is the principal stronghold of House Arryn.",
  },
  {
    name: "Dragonstone",
    description:
      "Dragonstone, or Dragonstone Castle, is the castle that stands upon the eponymous island located in Blackwater Bay. It is the ancestral seat of House Targaryen and the former stronghold of House Baratheon of Dragonstone, a cadet branch of House Baratheon of Storm's End.",
  },
];
export const characters = [
  ...
  {
    name: "King Consort Daemon Targaryen",
    description:
  ...
  {
    name: "Ser Otto Hightower",
    description:
      "Queen Alicent Hightower's father and the Hand of the King on King Viserys I Targaryen's Small Council and continued to hold his position under King Aegon II Targaryen until being replaced by Ser Criston Cole. When his daughter became queen, he began plotting to put her eldest son Aegon on the Iron Throne, instead of Rhaenyra.",
  },
  {
  ...
  },
  {
    name: "Mysaria",
    description:
      "A foreign-born brothel dancer who rose to become Prince Daemon Targaryen's paramour and most trusted confidante until they eventually parted ways. She is later known as the \"White Worm\" and leads a network of spies throughout King's Landing and becomes Rhaenyra's advisor.",
  },
  {
    name: "Ser Criston Cole",
    description:
      "A skilled swordsman from the Dornish Marches and the common-born son of the steward to the Lord of Blackhaven, who is hand-picked by Princess Rhaenyra to become a member of King Viserys I Targaryen's Kingsguard. He later replaces Ser Harrold Westerling as Lord Commander of the Kingsguard following the ascension of King Aegon II Targaryen, and also replaces Ser Otto Hightower as Hand of the King.",
  },
  {
    name: "Dowager Queen Alicent Hightower",
    description:
      "Princess Rhaenyra Targaryen's childhood companion and later the second wife and queen consort of King Viserys I Targaryen. She is raised in the Red Keep as part of the King's inner circle and is known as the comeliest woman in the court.",
  },
  {
  ...
  {
    name: "Lord Jason Lannister",
    description:
      "The Lord of Casterly Rock, head of House Lannister and Warden of the West. An arrogant hunter and a warrior, he unsuccessfully vies for the hand of Princess Rhaenyra Targaryen.",
  },
  {
    name: "Ser Tyland Lannister",
    description:
      "Lord Jason Lannister's younger twin brother and a cunning politician. He replaces Lord Corlys Velaryon as Master of Ships on King Viserys I Targaryen's Small Council and later switches his position to replace Lord Lyman Beesbury as the Master of Coin under King Aegon II Targaryen.",
  },
  {
    name: "Harry Collett",
    description:
      'Prince Jacaerys "Jace" Velaryon: The firstborn son of Princess Rhaenyra Targaryen and Ser Laenor Velaryon. He is a dragonrider who is bonded to the young dragon Vermax.',
  },
  {
    name: "King Aegon II Targaryen",
    description:
      "The sixth king of the Seven Kingdoms. He is the firstborn son of King Viserys I Targaryen and Queen Alicent Hightower, half-brother to Princess Rhaenyra Targaryen, husband to his sister-wife Helaena Targaryen, and father to her children. Despite the best efforts of his mother, his hedonism and depravity are legendary in King's Landing's Street of Silk. He is a dragonrider who is bonded to the young dragon Sunfyre, also known as \"Sunfyre the Golden\".",
  },
  {
    name: "Prince Aemond Targaryen",
    description:
  ...
  },
  {
    ...
    description:
      "The elder daughter of Prince Daemon Targaryen and Lady Laena Velaryon. She is a dragonrider who is bonded to the young dragon Moondancer.",
  },
  {
    name: "Lady Rhaena Targaryen",
    description:
      "The younger daughter of Prince Daemon Targaryen and Lady Laena Velaryon. She is in possession of a dragon egg, although it has yet to hatch.",
  },
  {
    name: "Queen Helaena Targaryen",
    description:
      "The secondborn child and only daughter of King Viserys I Targaryen and Queen Alicent Hightower, sister-wife of King Aegon II Targaryen, and mother to his children. She has a unique interest in bugs and often speaks in cryptic prophetic language. She is a dragonrider who is bonded to the dragon Dreamfyre.",
  },
  {
    name: "Grand Maester Orwyle",
    description:
      "A maester of the Citadel who replaces Mellos as the Grand Maester on King Viserys I Targaryen's Small Council and continues to hold his position under King Aegon II Targaryen.",
  },
  {
    name: "Hugh Hammer",
    description:
      'A blacksmith from King\'s Landing who struggles to care for his sick daughter. He later reveals himself to be a Targaryen bastard, the grandson of King Jaehaerys I Targaryen, and claims the dragon Vermithor, also known as "The Bronze Fury".',
  },
  {
    name: "Alyn of Hull",
    description:
      "Lord Corlys Velaryon's bastard son and a sailor in service to House Velaryon who saved Corlys' life in the Stepstones.",
  },
  {
    name: "Lord Cregan Stark",
    description:
      "The young Lord of Winterfell, head of House Stark and Warden of the North.",
  },
  {
    name: "Addam of Hull",
    description:
      "Lord Corlys Velaryon's bastard son, Alyn's brother, and a shipwright in the Velaryon fleet. He is later pursued by the dragon Seasmoke, who chooses Addam to be his dragonrider.",
  },
  {
    name: "Ulf White",
    description:
      "A denizen of King's Landing who claims to be a Targaryen bastard and the half-brother of King Viserys I and Prince Daemon Targaryen. He later claims the dragon Silverwing.",
  },
  {
    name: "Kat",
    description: "Hugh's wife and mother to his daughter.",
  },
  {
    name: "Ser Gwayne Hightower",
    description:
      "The son of Ser Otto Hightower and older brother of Dowager Queen Alicent Hightower.",
  },
  {
    name: "Alys Rivers",
    description: "A mysterious healer at Harrenhal in service to House Strong.",
  },
  {
    name: "Ser Simon Strong",
    description:
      "The great-uncle of Lord Larys Strong and the Castellan of Harrenhal.",
  },
];
export const episodes = [
  ...
  },
  {
    ...
    synopsis:
      "Daemon dreams that he decapitates a young Rhaenyra, who accused him of treason. Grand Maester Orwyle prepares Alicent an abortifacient tea. He professes ignorance when she asks whom Viserys named as heir. Criston beheads Lord Gunthor Darklyn of Duskendale, who refused allegiance. Alys Rivers tells Daemon that Harrenhal is haunted. Her sleep potion causes him to hallucinate seeing his deceased wife, Laena Velaryon. Rhaenyra returns to Dragonstone and agrees to a war using dragons. Rhaenys volunteers herself and her dragon, Meleys. Aegon complains about Aemond and Criston planning battles without him but Alicent dismisses this, saying he, lacking wisdom and knowledge, is inferior to Viserys as a king. She advises he serve the realm by doing nothing and defer to his advisors. Frustrated and drunk, Aegon flies his dragon, Sunfyre, to Rook's Rest. Rhaenys on Meleys burns Criston's troops while Aemond and Vhagar wait to ambush her. When Aegon and Sunfyre approach, Aemond delays attacking. As Meleys mauls Sunfyre, Aemond flies in and has Vhagar burn both dragons. Sunfyre falls with Aegon. Rhaenys and Meleys attack Vhagar, who also falls. As Rhaenys circles above, Vhagar suddenly rises and fatally throttles Meleys, plunging Rhaenys to her death. Criston awakens and finds Aemond with his sword drawn near Aegon, who lies motionless next to the heavily wounded Sunfyre.",
  },
  {
    season: 2,
    episode: 5,
